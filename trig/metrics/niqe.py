# This implementation of Natural Image Quality Evaluator is copied from https://github.com/xinntao/EDVR
...
def calculate_niqe(img, crop_border, input_order='HWC', convert_to='y'):
    ...
    # we use the official params estimated from the pristine dataset.
    niqe_pris_params = np.load('TRIG/trig/utils/niqe_pris_params.npz')
