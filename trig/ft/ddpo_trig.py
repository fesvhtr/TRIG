...
"""
CUDA_VISIBLE_DEVICES=3 python ddpo_trl_sd15.py \
    --num_epochs=15 \
    ...
    --log_with="wandb"
    --hf_user_access_token="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"
"""
...
from trig.metrics.trig_api import TRIGAPIMetric
from trl import DDPOConfig, DDPOTrainer, DefaultDDPOStableDiffusionPipeline
import json
import random


with open("/home/muzammal/Projects/TRIG/dataset/Trig/Trig-text-to-image/text-to-image-train.json", "r") as f:
...
def prompt_fn():
    selected_item = random.choice(prompt_data)
    prompt = selected_item["prompt"]
    dim = selected_item["dimension"]
    metadata = {
        "dimension": dim
    }
