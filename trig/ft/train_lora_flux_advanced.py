...
class DreamBoothDataset(Dataset):
    ...
    def __init__(
        ...
        try:
            from datasets import load_dataset, load_from_disk, Features, Value, Image
        except ImportError:
            raise ImportError(
        ...
        dataset = load_dataset(
            ...
            features=Features({"image": Image(), "prompt": Value("string")}),
            # no split=…
        )
...
def main(args):
    ...
    transformer._set_static_graph()
    if args.train_text_encoder:
        text_encoder_one._set_static_graph()
